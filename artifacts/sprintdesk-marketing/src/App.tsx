...
function Features() {
  return <Shell><Meta title="SprintDesk Features — Capture, Organize, Execute" description="Explore SprintDesk capabilities: Capture Inbox, Task Flow, Sprint Boards, Calendar, Command Center, and no-code automations." path="/features" /><main><section className="inner-hero"><div className="container-wide"><div className="eyebrow">The capability library</div><h1 className="display">Everything work needs to move forward.</h1><p>From the first raw thought to a visible team sprint, SprintDesk gives each kind of work a clear home.</p></div></section><section className="inner-section"><div className="container-wide">
    <article className="capability" id="capture"><div className="capability-copy"><div className="eyebrow">01 · Capture Inbox</div><h2 className="display">Catch the thought. Organize it when you’re ready.</h2><p>A permanently accessible personal inbox for thoughts, tasks, notes, links, and ideas—without requiring immediate organization.</p><div className="feature-mini">Private until you choose <strong>Triage to Board</strong>.</div></div><div className="capability-demo"><CaptureDemo /></div></article>
    <article className="capability" id="tasks"><div className="capability-copy"><div className="eyebrow">02 · Task management</div><h2 className="display">Give every task the right next place.</h2><p>Refine a captured item, choose Personal or Team Workspace, select a target board column, and set priority during triage.</p><div className="small-stat"><span>TRIAGE PATH</span><strong>Inbox → Todo → In Progress</strong></div></div><div className="capability-demo"><div className="surface" style={{ padding: 25 }}><div className="panel-title"><span>Task detail</span><span>PERSONAL</span></div><h3 style={{ margin: '22px 0 10px', fontSize: 20 }}>Fix mobile navbar</h3><p className="muted" style={{ fontSize: 13 }}>Refine the navigation at the 390px breakpoint before the next release.</p><div className="mock-list"><div className="mock-task"><span>Workspace</span><strong>Personal</strong></div><div className="mock-task"><span>Column</span><strong>Todo</strong></div><div className="mock-task"><span>Priority</span><strong style={{ color: 'hsl(var(--accent))' }}>High</strong></div></div></div></div></article>
    <article className="capability" id="sprints"><div className="capability-copy"><div className="eyebrow">03 · Dual-mode boards</div><h2 className="display">One workspace that adapts to the way you work.</h2><p>Personal Task Flow keeps individual work focused. Sprint Board brings story points, progress, swimlanes, epics, tags, and collaboration into a shared context.</p></div><div className="capability-demo"><BoardDemo full /></div></article>
    <article className="capability" id="calendar"><div className="capability-copy"><div className="eyebrow">04 · Interactive calendar</div><h2 className="display">See your deadlines before they become surprises.</h2><p>A monthly visual scheduler displays tasks based on due dates so upcoming deadlines and scheduled work are easy to scan.</p></div><div className="capability-demo"><CalendarDemo /></div></article>
    <article className="capability" id="command-center"><div className="capability-copy"><div className="eyebrow">05 · Command Center</div><h2 className="display">See your team’s heartbeat without chasing updates.</h2><p>Managers and team leads can see sprint progress, team velocity, open blockers, workload, active and completed tasks, and a real-time activity feed.</p></div><div className="capability-demo"><CommandCenter /></div></article>
    <article className="capability" id="automations"><div className="capability-copy"><div className="eyebrow">06 · No-code automations</div><h2 className="display">Let your workflow handle the busywork.</h2><p>Create rules using a simple When → Then → And builder. For example: when a task moves to In Review, set priority to High and assign it to the Project Manager.</p></div><div className="capability-demo"><AutomationDemo /></div></article>
  </div></section><FinalCTA /></main></Shell>;
}

function HowItWorks() {
  return <Shell><Meta title="How SprintDesk Works — From Capture to Execution" description="See how SprintDesk connects Capture, Triage, Focus, Execute, Monitor, and Automate into one workflow." path="/how-it-works" /><main><section className="inner-hero"><div className="container-wide"><div className="eyebrow">How it works</div><h1 className="display">The shortest path from a raw thought to coordinated work.</h1><p>Capture privately. Decide later. Move work into the context where it can actually move.</p></div></section><WorkflowSection /><section className="workspace-section"><div className="container-wide"><SectionHeading eyebrow="The handoff" title="Context travels with the task." body="The work does not have to choose between personal focus and team visibility. SprintDesk keeps the transition explicit." /><BoardDemo full /></div></section><FinalCTA /></main></Shell>;
}
